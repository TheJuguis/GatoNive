...
class MainActivity : AppCompatActivity() {
    ...
    fun clickImagen(view:View){
        ...
        for(i in 0 until contadorX){
            ...
            for (j in 0 until altoMatriz){
                ...
                if(gano==true){
                    ganador="x"
                    Toast.makeText(this,"Gano Jugador1 (X)",Toast.LENGTH_LONG).show()
                    dibujaLinea()
                    deshabilitar()
                    break
                }
        ...
        for(i in 0 until contadorO){
            ...
            for (j in 0 until altoMatriz){
                ...
                if(gano==true){
                    ganador="o"
                    Toast.makeText(this,"Gano Jugador2 (O)",Toast.LENGTH_LONG).show()
                    dibujaLinea()
                    deshabilitar()
                    break
                }
    ...
    fun dibujaLinea(){
        if(ganador=="x"){
            for (i in 0 until contadorX){
                if(posicionesX[i]==1){
                    imageView1?.setBackgroundColor(Color.CYAN)
                }
                if(posicionesX[i]==2){
                    imageView2?.setBackgroundColor(Color.CYAN)
                }
                if(posicionesX[i]==3){
                ...
                if(posicionesX[i]==6){
                    imageView6?.setBackgroundColor(Color.CYAN)
                }
                if(posicionesX[i]==7){
                    imageView7?.setBackgroundColor(Color.CYAN)
                }
                if(posicionesX[i]==8){
                    imageView8?.setBackgroundColor(Color.CYAN)
                }
                if(posicionesX[i]==9){
                    imageView9?.setBackgroundColor(Color.CYAN)
                }
            }
        }else{
            for (i in 0 until contadorO){
